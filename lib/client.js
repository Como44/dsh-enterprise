...
`
    ...
    function HomePage() {
      ...
      return el('div', { className: 'entm-page' },
        ...
        skills.length > 0 ? el('div', { className: 'entm-sec' },
          el('div', { className: 'entm-sec-head' },
            el('span', { className: 'entm-sec-title' }, '企业推荐能力'),
            el('span', { className: 'entm-sec-link', onClick: () => { store.page = 'skills'; emit() } }, '查看技能 →'),
          ),
          el('div', { className: 'entm-list' }, skills.map((sk) =>
            el('div', { key: sk.name, className: 'entm-row', onClick: () => { store.page = 'skills'; emit() } },
              el('span', { style: { display: 'flex' } }, el(Icon, { d: I.spark, size: 14 })),
              el('div', { className: 'entm-row-main' },
                el('div', { className: 'entm-row-title' }, `/${esc(sk.name)}`),
                el('div', { className: 'entm-row-sub' }, esc(sk.description))),
              el('span', { className: 'entm-tag accent' }, '技能'),
            )),
          ),
        ) : null,
      )
    ...
    function MembersPage() {
      ...
      return el('div', { className: 'entm-page' },
        ...
        el('table', { className: 'entm-table' },
          el('thead', null, el('tr', null,
            el('th', null, '成员'), el('th', null, '邮箱'), el('th', null, '角色'), el('th', null, '加入时间'), el('th', null, ''))),
    ...
    function UsagePage() {
      ...
      return el('div', { className: 'entm-page' },
        ...
        el('p', { className: 'entm-sub' }, '管理员视角：AI 大概被谁用了、用了多少。数据来自 DSH 会话统计（最近 40 个会话）。'),
        ...
        el('div', { className: 'entm-sec' },
          ...
          el('table', { className: 'entm-table' },
            el('thead', null, el('tr', null,
              ...
              el('th', null, '步骤'), el('th', null, 'LLM 时间'), el('th', null, '输出 Tokens'))),
    ...
    function SettingsPage() {
      ...
      const saveOrg = async () => {
        const ok = await post('org.update', { name, description: desc })
        if (ok) toast('企业信息已保存')
      }
